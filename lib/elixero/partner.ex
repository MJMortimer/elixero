defmodule EliXero.Partner do
  ...
  def upload_multipart(access_token, resource, api_type, path_to_file, name) do
    ...
    header = EliXero.Utils.Oauth.create_auth_header("POST", url, [oauth_token: access_token["oauth_token"]], name)

    EliXero.Utils.Http.post_multipart(url, header, path_to_file, [{"Name", name}])
  end
